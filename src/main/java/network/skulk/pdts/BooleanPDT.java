...
public final class BooleanPDT implements PersistentDataType<Byte, Boolean> {
    ...
    @Override public @NotNull Byte toPrimitive(final @NotNull Boolean complex, final @NotNull PersistentDataAdapterContext context) {
        return complex ? TRUE : FALSE;
    }

    @Override public @NotNull Boolean fromPrimitive(final @NotNull Byte primitive, final @NotNull PersistentDataAdapterContext context) {
