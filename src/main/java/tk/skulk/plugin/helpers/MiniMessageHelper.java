...
public abstract class MiniMessageHelper {
    ...
    public static @NotNull Component makeMessage(
        final @NotNull String color,
        final char symbol,
        final @NotNull String text,
        final @NotNull String... placeholders
    ) {
        return MiniMessageHelper.fmt(MiniMessageHelper.MESSAGE_TEMPLATE.formatted(
            color,
            symbol,
            color,
            text
    ...
    public static @NotNull Component fmt(
        final @NotNull String text,
        final @NotNull String... placeholders
    ) {
    ...
    public static @NotNull Component makeMessageWithComponent(
        final @NotNull String color,
        final char symbol,
        final @NotNull String text,
        final @NotNull Component... components
    ) {
        return MiniMessageHelper.fmtWithComponent(MiniMessageHelper.MESSAGE_TEMPLATE.formatted(
            color,
            symbol,
            color,
            text
    ...
    public static @NotNull Component fmtWithComponent(
        final @NotNull String text,
        final @NotNull Component... components
    ) {
